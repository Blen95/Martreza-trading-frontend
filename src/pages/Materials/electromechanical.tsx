  ...
  const categories = [
    {
      ...
      desc: "Reliable low and high-voltage cable systems for residential and commercial projects.",
      img: cablesImg,
    },
    {
      title: "Switchgear & Panels",
      desc: "Advanced distribution panels and control systems ensuring operational safety.",
      img: panelsImg,
    },
    {
      title: "HVAC & Mechanical Systems",
      desc: "Energy-efficient heating, ventilation, and cooling systems.",
      img: hvacImg,
    },
    {
      title: "Fire Safety Systems",
      desc: "Integrated fire detection and suppression systems for maximum safety compliance.",
      img: fireImg,
    },
  ];
      ...
      <section className="bg-gradient-to-br from-[#0B1C2D] via-[#0F2438] to-[#111827] text-white py-32">
        <Container size="lg">
          ...
          <Text size="lg" className="mt-6 text-gray-300 max-w-3xl">
            High-performance electrical and mechanical systems powering modern
      ...
      <section className="py-24 bg-gray-50 text-center">
        <Container size="md">
          <Title order={2} className="mb-6">
            Power Your Next Development Project
          </Title>
          <Button
            size="lg"
            radius="xl"
